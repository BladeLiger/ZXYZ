        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <?php endif; ?>
              <td><button class="btn btn-warning"><a href="<?php echo e(url('pb-editar/'.$pb->id)); ?>" style="text-decoration:none; color:#fff">Editar</a></button></td>
            </tr>
            <?php endforeach; ?>
          </tbody>
        </table>
