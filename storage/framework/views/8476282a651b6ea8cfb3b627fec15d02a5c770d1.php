...
<div class="row">
 ...
 <form method="post" id="formulario" enctype="multipart/form-data" action="<?php echo e(url('/postimgs')); ?>" >
 <?php echo e(csrf_field()); ?>
  ...
  <div class="form-group">
    <label>fecha publicacion</label>
     <input type="date"name="fecha_inicio"  min="<?php echo e($fecha_inicio); ?>" max="<?php echo e($fecha_fin); ?>" class="form-control"  value="<?php echo e(old('fecha_inicio')); ?>">
  </div>
  <div class="form-group">
    <label>fecha finalizacion</label>
    <input type="date" id='fecha_fin' name="fecha_fin" min="<?php echo e($fecha_inicio); ?>" max="<?php echo e($fecha_fin); ?>" class="form-control"  value="<?php echo e(old('fecha_fin')); ?>">
  </div>
  <div class="form-group">
