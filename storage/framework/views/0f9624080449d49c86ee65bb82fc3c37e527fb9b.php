...
<div class="navbar">
    <div class="navbar-inner">
        <div class="container">
            <a href="#" class="brand">
                <img src="<?php echo e(asset('images/logo1.png')); ?>" width="120" height="40" alt="Logo" />
 ...
 <div id="home">
            ...
            <div id="da-slider" class="da-slider">
                ...
                <div class="container">
                    ...
                    <div class="da-slide">
                        ...
                        <div class="da-img">
                            <img src="<?php echo e(asset('images/Slider01.png')); ?>" alt="image01" width="320">
                        </div>
                    </div>
                    <!-- End first slide -->
                    <!-- Start second slide -->
                    <div class="da-slide">
                        ...
                        <a href="#" class="da-link button">Read more</a>
                        <div class="da-img">
                            <img src="<?php echo e(asset('images/Slider02.png')); ?>" width="320" alt="image02">
                        </div>
                    </div>
                    <!-- End second slide -->
                    <!-- Start third slide -->
                    <div class="da-slide">
                        ...
                        <a href="#" class="da-link button">Read more</a>
                        <div class="da-img">
                            <img src="<?php echo e(asset('images/Slider03.png')); ?>" width="320" alt="image03">
                        </div>
                    </div>
                    <!-- Start third slide -->
        ...
        <div class="section primary-section" id="service">
            <div class="container">
                ...
                <div class="title">
                    <h1><?php echo e($pubgob[0]['pagina']); ?></h1>
                    <!-- Section's title goes here -->
                    <p>Pagina Oficial de <?php echo e($pubgob[0]['pagina']); ?> del departamento de Potosi</p>
                ...
                <div class="row-fluid">
                    <div class="span4">
                        <div class="centered service">
                            <div class="circle-border zoom-in">
                                <img class="img-circle" src="<?php echo e(asset('images/Service1.png')); ?>" alt="service 1">
                            </div>
                            <h3>Modern Design</h3>
                    ...
                    <div class="span4">
                        <div class="centered service">
                            <div class="circle-border zoom-in">
                                <img class="img-circle" src="<?php echo e(asset('images/Service2.png')); ?>" alt="service 2" />
                            </div>
                    ...
                    <div class="span4">
                        <div class="centered service">
                            <div class="circle-border zoom-in">
                                <img class="img-circle" src="<?php echo e(asset('images/Service3.png')); ?>" alt="service 3">
                            </div>
                            <h3>Clean Code</h3>
            ...
            <div class="container">
                ...
                <div class="row-fluid team">
                    <div class="span4" id="first-person">
                        <div class="thumbnail">
                            <img src="<?php echo e(asset('images/Team1.png')); ?>" alt="team 1">
                            <h3>John Doe</h3>
                            <ul class="social">
                                <li>
                                    <a href="">
                    ...
                    <div class="span4" id="second-person">
                        <div class="thumbnail">
                            <img src="<?php echo e(asset('images/Team2.png')); ?>" alt="team 1">
                            <h3>John Doe</h3>
                            <ul class="social">
                                <li>
                                    <a href="">
                    ...
                    <div class="span4" id="third-person">
                        <div class="thumbnail">
                            <img src="<?php echo e(asset('images/Team3.png')); ?>" alt="team 1">
                            <h3>John Doe</h3>
                            <ul class="social">
                                <li>
                                    <a href="">
                    ...
                    <div class="row">
                        <div class="span4">
                            <div class="testimonial">
                                ...
                                <div class="whopic">
                                    <div class="arrow"></div>
                                    <img src="<?php echo e(asset('images/Client1.png')); ?>" class="centered" alt="client 1">
                                    <strong>John Doe
                                        <small>Client</small>
                                    </strong>
                                </div>
                        ...
                        <div class="span4">
                            <div class="testimonial">
                                ...
                                <div class="whopic">
                                    <div class="arrow"></div>
                                    <img src="<?php echo e(asset('images/Client2.png')); ?>" class="centered" alt="client 2">
                                    <strong>John Doe
                                        <small>Client</small>
                                    </strong>
                                </div>
                        ...
                        <div class="span4">
                            <div class="testimonial">
                                ...
                                <div class="whopic">
                                    <div class="arrow"></div>
                                    <img src="<?php echo e(asset('images/Client3.png')); ?>" class="centered" alt="client 3">
                                    <strong>John Doe
                                        <small>Client</small>
                                    </strong>
                                </div>
            ...
            <div class="container centered">
                <div class="sub-section">
                    ...
                    <ul class="row client-slider" id="clint-slider">
                        <li>
                            <a href="">
                                <img src="<?php echo e(asset('images/clients/ClientLogo01.png')); ?>" alt="client logo 1">
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="<?php echo e(asset('images/clients/ClientLogo02.png')); ?>" alt="client logo 2">
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="<?php echo e(asset('images/clients/ClientLogo03.png')); ?>" alt="client logo 3">
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="<?php echo e(asset('images/clients/ClientLogo04.png')); ?>" alt="client logo 4">
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="<?php echo e(asset('images/clients/ClientLogo05.png')); ?>" alt="client logo 5">
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="<?php echo e(asset('images/clients/ClientLogo02.png')); ?>" alt="client logo 6">
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img src="<?php echo e(asset('images/clients/ClientLogo04.png')); ?>" alt="client logo 7">
                            </a>
                        </li>
                    </ul>
                </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/login')); ?>">
                                    ...
                                    <div class="control-group<?php echo e($errors->has('ci') ? ' has-error' : ''); ?>">
