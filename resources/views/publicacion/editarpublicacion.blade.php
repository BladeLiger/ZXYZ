...
<div class="row">
 ...
 <form method="post" id="formulario" enctype="multipart/form-data" action="{{ url('/editpub') }}" >
 {{ csrf_field() }}
  ...
  <div class="form-group">
    <label>fecha publicacion</label>
     <input type="date"name="fecha_inicio"  min="{{$fecha_inicio}}" max="{{$fecha_fin}}" class="form-control"  value="{{$publicacion['fecha_publicacion']}}">
  </div>
  <div class="form-group">
    <label>fecha finalizacion</label>
    <input type="date" id='fecha_fin' name="fecha_fin" min="{{$fecha_inicio}}" max="{{$fecha_fin}}" class="form-control"  value="{{$publicacion['fecha_caducidad']}}">
  </div>
  <div class="form-group">
